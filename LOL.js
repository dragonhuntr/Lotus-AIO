var _cf = _cf || [],
    bmak = bmak || {
        ...
        gd: function() {
            var a = bmak.uar(), //User agent
                t = "" + bmak.ab(a), //Generates number with user agent
                e = bmak.start_ts / 2,
            ...
            var d = Math.random(),
                k = bmak.pi(1e3 * d / 2),
                s = d + "";
            s = s.slice(0, 11) + k, bmak.get_browser(), bmak.bc(), bmak.bmisc(), a + ",uaend," + bmak.xagg + "," + bmak.psub + "," + bmak.lang + "," + bmak.prod + "," + bmak.plen + "," + bmak.pen + "," + bmak.wen + "," + bmak.den + "," + bmak.z1 + "," + bmak.d3 + "," + n + "," + o + "," + m + "," + r + "," + i + "," + c + "," + b + "," + bmak.bd() + "," + t + "," + s + "," + e + ",loc:" + bmak.loc
            console.log(s)
            return s
        },
        ...
        bpd: function() {
            ...
            try {
                ...
                var n = bmak.gd(), //User Agent + extra
                    o = window.DeviceOrientationEvent ? "do_en" : "do_dis", //do_en
                    m = window.DeviceMotionEvent ? "dm_en" : "dm_dis", //dm_en
                    r = window.TouchEvent ? "t_en" : "t_dis", //t_en
                    i = o + "," + m + "," + r, //"do_en,dm_en,t_en"
                    c = bmak.getforminfo(), //whole lotta red
                    b = bmak.getdurl(), //Current product url
                    d = bmak.aj_type + "," + bmak.aj_indx; //-1,0
                !bmak.fpcf.fpValCalculated && (0 == bmak.js_post || bmak.aj_indx > 0) && bmak.fpcf.fpVal(); //false
                var k = bmak.ke_vel + bmak.me_vel + bmak.doe_vel + bmak.dme_vel + bmak.te_vel + bmak.pe_vel, //126839417?
                    s = bmak.get_cf_date() - bmak.start_ts, //timer?
                    l = bmak.pi(bmak.d2 / 6), //2836?
                    u = bmak.fas(), //30261693?
                    //weird shit
                    ...
                    //joining weird shit
                    f = _.join(","),
                    p = "" + bmak.ab(bmak.fpcf.fpValstr); //5478
                bmak.np(); //useless maybe?
                var v = bmak.sed(), //"0,0,0,0,1,0,0"
                    h = bmak.mn_get_current_challenges(), //none
                    g = "",
                    w = "",
                    y = "";
                if (void 0 !== h[1]) {
                ...
                try {
                    bmak.sd_debug(",s2:" + a), bmak.sensor_data = 1.54 + "-1,2,-94,-100," + bmak.uar() + "-1,2,-94,-120," + a.replace(/\"/g, "\\'")
                } catch (a) {
                    bmak.sd_debug(",s3:" + a)
                }
            }
